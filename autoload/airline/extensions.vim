...
if exists('g:airline_nerd_origin_stat') && get(g:, 'airline_nerd_origin_stat', 1)
  let s:airline_nerd_stat = g:NERDTreeStatusline
else
  let s:airline_nerd_stat = 'NERD'
endif
let s:filetype_overrides = {
      \ 'nerdtree': [ s:airline_nerd_stat, '' ],
      \ 'gundo': [ 'Gundo', '' ],
