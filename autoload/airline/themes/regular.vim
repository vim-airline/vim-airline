...
let s:palette.normal = {
    ...
    \ 'airline_c' : [ s:gui_white, s:gui_black, 255, 234 ],
    \ 'airline_x' : [ s:gui_white, s:gui_black, 255, 234 ],
    \ 'airline_y' : [ s:gui_white, s:gui_black, 255, 234 ],
...
let s:palette.insert = {
    \ 'airline_a' : [ s:gui_white, s:gui_black, 238, 110 ],
    \ 'airline_c' : [ s:gui_white, s:gui_black, 110, 235 ]
    \}

let s:palette.replace = s:palette.normal
let s:palette.replace = {
    \ 'airline_a' : [ s:gui_white, s:gui_black, 236, 174 ],
    \ 'airline_c' : [ s:gui_white, s:gui_black, 174, 235 ]
    \}

let s:palette.visual = s:palette.normal
let s:palette.visual = {
    \ 'airline_a' : [ s:gui_white, s:gui_black, 236, 182 ],
    \ 'airline_c' : [ s:gui_white, s:gui_black, 182, 235 ]
    \}
