...
function! airline#extensions#hunks#get_hunks()
  ...
  if exists("b:airline_hunks") &&
    ...
    \ airline#util#cur_window_statusline_width() == get(s:, 'airline_winwidth', 0) &&
  ...
  if !empty(hunks)
    for i in [0, 1, 2]
      if (s:non_zero_only == 0 && airline#util#cur_window_statusline_width() > 100) || hunks[i] > 0
  ...
  let s:airline_winwidth = airline#util#cur_window_statusline_width()
  return string
endfunction
